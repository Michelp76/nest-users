...
CREATE TABLE IF NOT EXISTS "bookings"."seats" (
	"aircraft_code" char(3) PRIMARY KEY NOT NULL,
	"seat_no" varchar(4) PRIMARY KEY NOT NULL,
...
--> statement-breakpoint
DO $$ BEGIN
 ALTER TABLE "bookings"."flights" ADD CONSTRAINT "flights_arrival_airport_airports_data_airport_code_fk" FOREIGN KEY ("arrival_airport") REFERENCES "bookings"."airports_data"("airport_code") ON DELETE no action ON UPDATE no action;
EXCEPTION
 WHEN duplicate_object THEN null;
END $$;
--> statement-breakpoint
